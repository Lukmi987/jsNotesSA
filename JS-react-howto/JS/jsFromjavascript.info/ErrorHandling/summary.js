...
Error objects have following properties:
  ...
  We can also generate our own errors using the throw operator. Technically, the argument of throw can be anything, but usually
   it’s an error object inheriting from the built-in Error class
...
so it should rethrow errors it doesn’t know
